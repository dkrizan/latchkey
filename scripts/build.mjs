#!/usr/bin/env node
/**
 * Builds browser-specific bundles from ./src:
 *
 *   dist/chrome/   + dist/autologin-rules-chrome-<version>.zip
 *   dist/firefox/  + dist/autologin-rules-firefox-<version>.zip
 *
 * The only difference between the two is the manifest (background declaration
 * and Firefox-specific settings). No bundler, no dependencies.
 *
